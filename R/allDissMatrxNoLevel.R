#' Example of the output produced by the function \code{allSorenThreshold}. It contains the dissimilarity matrices without GO-Level restriction across the ontologies BP, CC and MF.
#'
#' @description
#' This object contains the matrices of dissimilarities between the 7 lists from \code{allOncoGeneLists}, computed based on the irrelevance threshold that makes them equivalent without GO-Level restriction across the ontologies BP, CC and MF.
#'
#' @details
...
#' @usage data("allDissMatrxNoLevel")
"allDissMatrxNoLevel"

#' Example of the output produced by the function \code{allEquivTestSorensen} using the approximated bootstrap distribution.
#'
#' @description
#' This object contains all the outputs for the equivalence tests to compare all possible pairs of lists from \code{\link{allOncoGeneLists}} without GO-Level restriction, and for the ontologies BP, CC, and MF, using the approximated bootstrap distribution.
#'
#' @details
...
#' @usage data(allEqTests_bootNoLevel)
"allEqTests_bootNoLevel"

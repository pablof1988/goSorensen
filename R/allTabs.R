#' An example of "allTableList" object resulting from a call to 'buildEnrichTable'
#'
...
#' time. The present version of these data was generated under Bioconductor version 3.16.
#'

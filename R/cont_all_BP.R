#' Example of the output produced by the function \code{buildEnrichTable}. It contains the enrichment contingency tables for all the lists from \code{allOncoGeneLists} for ontology BP without GO-Level restriction.
#'
#' @description

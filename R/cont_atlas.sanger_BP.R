#' Example of the output produced by the function \code{buildEnrichTable}. It contains the enrichment contingency table for two lists for ontology BP without GO-Level restriction.
#'
#' @description
...
#' @usage data(cont_atlas.sanger_BP)

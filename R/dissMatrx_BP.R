#' Example of the output produced by the function \code{sorenThreshold}. It contains the dissimilarity matrix for the ontology BP without GO-Level restriction.
#'
#' @description
#' This object contains the matrix of dissimilarities between the 7 lists from \code{allOncoGeneLists}, computed based on the irrelevance threshold that makes them equivalent for the ontology BP without GO-Level restriction.
#'
#' @details

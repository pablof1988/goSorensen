#' Example of the output produced by the function \code{equivTestSorensen}. It contains all the possible equivalence tests for the lists from \code{allOncoGeneLists} in ontology BP without GO-Level restriction.
#'
#' @description

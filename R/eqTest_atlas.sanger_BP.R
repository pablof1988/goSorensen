#' Example of the output produced by the function \code{equivTestSorensen}. It contains the equivalence test for comparing two lists in ontology BP without GO-Level restriction.
#'
#' @description
...
#'
#' @format An exclusive object from \code{goSorensen} of the class "equivSDhtest"
#' @usage data(eqTest_atlas.sanger_BP)

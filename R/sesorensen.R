...
#' representing a 2x2 contingency table, or a "character" (a set of gene
#' identifiers) or "list" or "tableList" object.
#' See the details section for more information.
#' @param y an object of class "character" representing a vector of gene
#' identifiers (e.g., ENTREZ).
#' @param check.table Boolean. If TRUE (default), argument
#' \code{x} is checked to adequately
#' represent a 2x2 contingency table. This checking is performed by means of
#' function
#' \code{nice2x2Table}.
...
#' Sorensen-Dice dissimilarity, given a 2x2 arrangement of frequencies (either
...
#'
#' In the "numeric" interface, if \code{length(x) >= 3}, the values are
#' interpreted as
...
#' (e.g., ENTREZ).
#' Then the standard error for the dissimilarity between lists \code{x} and
...
#' standard errors of the dissimilarity between these gene lists are computed.
#'
#' If \code{x} is an object of class "tableList", the standard error of the S
...
#' enrichment,
#' \code{\link{nice2x2Table}} for checking the validity of enrichment
#' contingency tables,\code{\link{dSorensen}} for computing the Sorensen-Dice
#' dissimilarity, \code{\link{duppSorensen}} for the upper limit of a one-sided
#' confidence interval  of the dissimilarity, \code{\link{equivTestSorensen}}
